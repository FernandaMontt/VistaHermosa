<%-- 
    Document   : Resolucion
    Created on : 08-10-2018, 20:34:58
    Author     : note
--%>
    ...
    <body style="padding-top: 50px;">
        ...
        <section class="body-block">
            ...
            <br>
                <table id="tabla">
                    <thead>
                        <th><strong>Decreto Municipal <%=permisoResolucionDAO.read(permiso.getId_solicitud()).getId_resolucion()%></strong></th>
                        <th><!--permisoTipoDAO.read(permiso.getTipo()).getTipo()%> <%=permiso.getId_solicitud() %>--></th>
                    </thead>
                    <tbody>
                        <tr>
                            <td>Funcionario: </td>
                        ...
                        <tr>
                            ...
                            <td><strong><%=jefeInterno.getNombre()%> <%=jefeInterno.getApellido()%></strong></td>
                        </tr>
                        <tr>
                            <td>Fecha de Decreto:</td>
                            <td><%=Fechas.toStringFecha(resolucion.getFecha_resolucion())%></td>
                        </tr>
                    </tbody>
                </table>
