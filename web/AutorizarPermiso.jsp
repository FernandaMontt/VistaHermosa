<%-- 
    Document   : AutorizarPermiso
    Created on : 08-10-2018, 20:33:56
    Author     : note
--%>
                ...
                <div class="row-fluid table-responsive">
                    ...
                    <form name="formModificarPermiso" action="ActualizarPermiso" method="POST">
                        <table class="table table-hover dataTable no-footer">
                            <thead>
                                <tr>
                                    <th style="font-size:25px; text-align: center" class="text-center" scope="col" colspan="2">Permiso <%=permisoTipoDAO.read(permiso.getId_tipo_permiso()).getPermiso() %> #<%=permiso.getId_solicitud() %></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><%=usuarioDAO.read(permiso.getId_usuario()).getRut()%></td>
                                </tr>
                                <tr>
                                    <td>Departamento/Cargo del funcionario: </td>
                                    <td><%=usuarioDepartamentoDAO.read(usuarioDAO.read(permiso.getId_usuario()).getId_departamento()).getNombre() %>/<%=usuarioCargoDAO.read(usuarioDAO.read(permiso.getId_usuario()).getId_cargo()).getNombre() %></td>
                                </tr>
                                <tr>
