<%-- 
    ...
    Created on : 08-10-2018, 14:29:31
    Author     : note
--%>

<%@page import="DTO.UsuarioPerTipoPermisoDTO"%>
<%@page import="DTO.PermisoResolucionDTO"%>
...
<html>
    ...
    <body style="padding-top: 50px;">
        <%
            ...
            PermisoResolucionDTO resolucion = (PermisoResolucionDTO)request.getSession().getAttribute("resolucion");
            UsuarioPerTipoPermisoDTO tipopermiso = (UsuarioPerTipoPermisoDTO)request.getSession().getAttribute("tipopermiso");
            if(usuario.getId_perfil() != 5 || usuario == null){
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <form action="VerResolucion" method="POST">
                                                        <td>
                                                            <% if( permisoResolucionDAO.read(permiso.getId_solicitud()).getId_solicitud() != 0){%>
                                                            <button class="btn btn-link form-control" type="submit" name="id_resolucion" value="<%=permiso %>"><i class="fas fa-external-link-alt"></i> Decreto <%=resolucion.getFecha_resolucion() %></button>
                                                            <%}%>
                                                        </td>
                                                    </form>
                                                </tr>
                                                            ...
                                                            <table class="table" >
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><%=usuario.getF_legal() %></td>
                                                                        <!--<td><%=usuario.getP_administrativo() - permisoDAO.sum_Usuario_Estado_Tipo(usuario.getRut(), 1, 1) %></td>-->
