...
<html>
    ...
    <body>
                    ...
                    <div class="col-md-6 login-sec">
                        ...
                        <form class="login-form" name="form" id="form"  action="ValidarIngreso" method="POST">
                            <div class="form-group">
                                ...
                                <input autofocus required id="usuario" type="text"  name="usuario" value="" class="form-control" minLength="10" maxLength="15" title="Ingresar usuario valido." placeholder="usuario valido">  
                            </div>
                            <div class="form-group">
      ...
      <div class="container">
        <span class="text-muted">©2018 - GGD</span>
      </div>
    </footer>
