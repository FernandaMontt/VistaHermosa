<%-- 
    Document   : MenuJefeSuperior
    Created on : 08-10-2018, 14:29:57
    Author     : note
--%>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <form action="VerPermiso" method="POST">
                                                    <% if(permiso.getId_solicitud() != 0){%>
                                                        <button class="btn btn-link form-control" type="submit" name="id_permiso" value="<%=permiso.getId_solicitud() %>"><i class="fas fa-external-link-alt"></i> <%=permiso.getId_solicitud() %></button>
                                                    <%}%>
                                                </form>
                                                </td>
                                                <td>    
                                                <form action="VerResolucion" method="POST">
                                                    ...
                                                    <button class="btn btn-link form-control" type="submit" name="id_resolucion" value="<%=permisoResolucionDAO.read(permiso.getId_solicitud()).getId_resolucion()%>"><i class="fas fa-external-link-alt"></i> <%=permisoResolucionDAO.read(permiso.getId_solicitud()).getFecha_resolucion()%></button>
                                                    <%}%>
                                                </form>
                                                </td>
                                            </tr>
                                    ...
                                    <table id="tabla-resoluciones" class="table table-hover dataTable no-footer">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <form action="VerResolucion" method="POST">
                                                        <!--<button value="<%=permisoResolucionDAO.read(permiso.getId_solicitud()).getId_resolucion()%>" type="submit" name="id_resolucion" class="btn btn-link btn-sm">Ver detalle</button>-->
                                                        <button class="btn btn-link form-control" type="submit" name="id_resolucion" value="<%=permisoResolucionDAO.read(permiso.getId_solicitud()).getId_resolucion()%>"><i class="fas fa-external-link-alt"></i> Decreto <%=permisoResolucionDAO.read(permiso.getId_solicitud()).getFecha_resolucion()%></button>
                                                </form>
                                                </td>
                                            </tr>
                                            <%}%>
