<%-- 
    ...
    Created on : 08-10-2018, 20:34:11
    Author     : note
--%>
                        ...
                        <table class="table table-hover dataTable no-footer">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input minLength="3" maxLength="20" required class="form-control" type="password" name="claveActual" /></td>
                                </tr>
                                <tr>
                                    <td>Ingrese clave nueva:</td>
                                    <td><input title="Clave debe poseer al menos una letra mayúscula, una letra minúscula y un número." pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" minLength="3" maxLength="20" required class="form-control" type="password" name="claveNueva1" /></td>
                                </tr>
                                <tr>
                                    <td>Repita clave:</td>
                                    <td><input pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" minLength="3" maxLength="20" required class="form-control" type="password" name="claveNueva2" /></td>
                                </tr>
                                <tr>
                                    <td colspan="2" style=" text-align: center"><button type="submit" class="btn btn-success"><i class="fas fa-user-edit"></i> Modificar</button></td>
                                </tr>
                            </tbody>
                        </table><br>
                    </form>
