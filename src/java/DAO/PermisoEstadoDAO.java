...
public class PermisoEstadoDAO {
    ...
    private static final String SQL_READ = "SELECT * FROM ESTADO_PERMISO WHERE ID_ESTADO = ?";
    private static final String SQL_READALL = "SELECT * FROM ESTADO_PERMISO";
    ...
    public PermisoEstadoDTO read(Object key) {
        ...
        try {
            ...
            while (resultado.next()) {
                permisoEstado = new PermisoEstadoDTO(resultado.getInt(1), resultado.getString(2));
            }
            ps.close();
    ...
    public ArrayList<PermisoEstadoDTO> readAll() {
        ...
        try {
            ...
            while (rs.next()) {
                listado.add(new PermisoEstadoDTO(rs.getInt(1), rs.getString(2)));
            }
            rs.close();
        } catch (SQLException ex) {
            Logger.getLogger(PermisoEstadoDTO.class.getName()).log(Level.SEVERE, null, ex);
